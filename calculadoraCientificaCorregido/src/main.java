                ...
                case 2://CON LAS FRACCONES 
                    ...
                    switch(opti){
                        ...
                        case 5://EXPONENTE fracciones 
                            System.out.println("El resultado con la divicion de cociente es:"+f1.potenciaFracciones());
                        break;
                ...
                case 4://FIGURAS GEOMETRICAS
                    ...
                    switch(figuras){
                        case 1://cuadrado
                            ...
                            int c=leer.nextInt();
                            cuadrado o1=new cuadrado(c);
                            System.out.println("El area del cuadrado es:"+o1.calcularFiguras());
                        break;
                        case 2://rectangulo
                            System.out.println("Introdusca los lados del rectangulo ");
                            int r=leer.nextInt();
                            int Rr=leer.nextInt();
                            rectangulo o2=new rectangulo(r, Rr);
                            System.out.println("El area del rectangulo es:"+o2.calcularFiguras());
                        break;
                        case 3://triangulo rectangulo
                            System.out.println("Introdusca los lados del triangulo rectangulo ");
                            int tr=leer.nextInt();
                            int TR=leer.nextInt();
                            rectangulo o3=new rectangulo(tr, TR);
                        ...
                        case 4://circulo
                            ...
                            int cr=leer.nextInt();
                            circulos o4=new circulos(cr);
                            System.out.println("El area del circulo es:"+o4.calcularFiguras());
                        break;
                        case 5://elipce
                            System.out.println("Introdusca el radio del circulo mayor y del menor");
                            int crm=leer.nextInt();
                            int CRM=leer.nextInt();
                            elipse o5=new elipse(crm,CRM);
                            System.out.println("El area del triangulo rectangulo es:"+o5.calcularFiguras());
                        break;
                        case 6://circulo Hueco
                            System.out.println("Introdusca el radio del circulo mayor y del menor");
                            int crma=leer.nextInt();
                            int CRME=leer.nextInt();
                            figuraGeometrica o6=new figuraGeometrica(crma,CRME);
                        ...
                        case 7://trapecio
                            ...
                            int BM=leer.nextInt();
                            int H=leer.nextInt();
                            figuraGeometrica o7=new figuraGeometrica(bm,BM,H);
                        ...
                        case 8://cubo
                            ...
                            cuadrado o8=new cuadrado(cubo);
                            System.out.println("El area del cubo es:"+o8.calcularFiguras3d());
                        break;
                        case 9://rectangulo tridimencional
                            ...
                            rectangulo3d o9=new rectangulo3d(rect, largo, hal);
                            System.out.println("El area del rectangulo tri es:"+o9.calcularFiguras());
                        break;
                        case 10://esfera
                            System.out.println("Introdusca el radio de la esfera");
                            int esfera=leer.nextInt();
                            circulos o10=new circulos(esfera);
                            System.out.println("El area de la esfera es:"+o10.calcularFiguras3d());
                        break;
                        case 11://cilindro
                            ...
                            figuraGeometrica o11=new figuraGeometrica(r1, R2, HALTURA);
